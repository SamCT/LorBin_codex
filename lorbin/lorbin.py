...
def parser_args():
    ...
    for p in [bin_mode, cluster]:
        ...
        p.add_argument('--recluster_impl', choices=['optimized', 'optimized_2', 'original', 'cuda', 'graph_cuda', 'birch_cuda'], default='original',
                      help='Stage-2 reclustering implementation to run (default: original; optimized_2 uses tighter stage-2 loop control and threshold selection; cuda/birch_cuda/graph_cuda require CUDA-capable PyTorch)')
